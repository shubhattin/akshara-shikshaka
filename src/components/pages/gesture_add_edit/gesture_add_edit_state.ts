...
import type { GesturePoints, Gesture, AnimationGesture } from '~/tools/stroke_data/types';
...
export const font_size_atom = atom(
  /* SAFETY: validated - DEFAULT_FONT_SIZE is number from controlled constant */ DEFAULT_FONT_SIZE as number
);
...
export const current_gesture_recording_points_atom = atom<GesturePoints[]>([]);
/**
...
export const DEFAULTS = {
  ...
  GESTURE_SIMULATE_PRESSURE: false
} as const;
