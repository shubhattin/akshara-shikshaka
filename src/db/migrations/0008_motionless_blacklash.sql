...
--> statement-breakpoint
ALTER TABLE "gesture_text_key_category_join" ADD CONSTRAINT "text_key_category_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."gesture_categories"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
